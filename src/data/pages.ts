...
export const pageBriefs: PageBrief[] = [
  ...
  { title: 'ChatGPT CarPlay Requirements', slug: 'chatgpt-carplay-requirements', cluster: 'ChatGPT CarPlay', primaryKeyword: 'chatgpt carplay requirements', pageType: 'Requirements', status: 'confirmed', heroImage: images.carplay, audience: 'iPhone users checking eligibility before setup', focus: 'summarizes iPhone, iOS, ChatGPT app, CarPlay, microphone, account, and regional requirements', description: 'Check the practical requirements for using ChatGPT in CarPlay, including iPhone, iOS, app, permissions, vehicle connection, and account status.', relatedSlugs: ['chatgpt-carplay', 'how-to-use-chatgpt-in-carplay', 'chatgpt-carplay-not-showing'] },
